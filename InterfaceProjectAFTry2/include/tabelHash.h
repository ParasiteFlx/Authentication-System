...
public:
    ...
    void autentificare(struct utilizator &utilizator, int &autentificat);
    ...
    void adaugareUtilizator(tabelHash th);

    void informatiiCont(struct utilizator utilizatorCurent);

    void initializareLista(tabelHash th);
